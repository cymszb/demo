...
public class ArcProgress extends View {
    ...
    private boolean only_progress = false;
    ...
    private static final String INSTANCE_ONLY_PROGRESS = "only_progress";
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        only_progress = attributes.getBoolean(R.styleable.ArcProgress_only_progress,false);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!only_progress && !TextUtils.isEmpty(text)) {
            textPaint.setColor(textColor);
            textPaint.setTextSize(textSize);
